...
(defrule HighAC
    ...
    (assert (Room_1_Air_Conditioned (new FuzzyValue ?*fanSpeed* "high")))
...
(defrule MediumAc
    ...
    (assert (Room_1_Air_Conditioned (new FuzzyValue ?*fanSpeed* "low")))
...
(defrule LowAc
    ...
    (assert (Living_Room_Air_Conditioned (new FuzzyValue ?*fanSpeed* "low")))
