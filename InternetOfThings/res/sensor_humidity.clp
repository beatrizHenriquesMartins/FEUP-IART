...
(bind ?insideHumiditySensor (new HumiditySensor "Inside Humidity Sensor" 100 ?*humidityFvar*))
(add ?insideHumiditySensor)

(bind ?outsideHumiditySensor (new HumiditySensor "Outside Humidity Sensor" 50 ?*humidityFvar*))
(add ?outsideHumiditySensor)

(bind ?soilHumiditySensor (new HumiditySensor "Soil Humidity Sensor" 30 ?*humidityFvar*))
